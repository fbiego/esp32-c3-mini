...
public:
  LGFX(void)
  {
    ...
    {                                      // Set the display panel control.
      ...
      cfg.offset_rotation = 2;    // Value 0~7 in rotation direction (4~7 is inverted)
      ...
      cfg.invert = false;          // As a result, the brightness and darkness of the face plate is reversed, and the setting is true
    ...
    { // Sets touchscreen control. (Delete if not needed)
      ...
      cfg.offset_rotation = 2; // Adjust if display and touch orientation do not match. Set to a value between 0 and 7
